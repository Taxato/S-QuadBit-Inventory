...
const model = {
	...
	data: {
		tags: [
			{ name: "verktøy", color: "#FFB3BA" },
			{ name: "batteri", color: "#FFDFBA" },
			{ name: "12v", color: "#FFF3B0" },
			{ name: "ryobi", color: "#BAFFC9" },
			{ name: "snekring", color: "#B5EAD7" },
			{ name: "håndverktøy", color: "#C7CEEA" },
			{ name: "18v", color: "#D5AAFF" },
			{ name: "Meec", color: "#A0E7E5" },
			{ name: "sag", color: "#FFAAC9" },
			{ name: "forbruksvare", color: "#FFD6A5" },
			{ name: "bøtte", color: "#FDFFB6" },
			{ name: "badeand", color: "#CAFFBF" },
			{ name: "leke", color: "#9BF6FF" },
			{ name: "badekar", color: "#AFCBFF" },
			{ name: "skru", color: "#FFC6FF" },
		],
		items: [
			{
